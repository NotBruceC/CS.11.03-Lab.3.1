            ...
            if (Attackpunch.getAttack() - devil1.getHp() == 0) {
                ...
                if (WakeUp1.equals("no")) {
                    ...
                    if (Reply3.equals("no")) {
                        ...
                        if (reply4.equals("no")) {
                            System.out.println("You earned a badge: no");
                            scanner.close();
                        } else {
                            System.out.println("A mysterious blue figure sneak attacked you. You fainted..");
                            ...
                            if (decision2.equals("run") || decision2.equals("Run")  ) {
